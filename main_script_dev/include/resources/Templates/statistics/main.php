...
<div class="contentNavi subNavi">
   ...
   <div class="scrollingContainer">
		...
		<div class="content favor <?=$favorTabId==7 ? "favorActive" : ''; ?> favorKey7" > 
			<a id="<?=$button_id=get_button_id(); ?>" href="statistiken.php?id=7" class="tabItem <?=$vars['BonusTabProperties']['active'] ? 'active' : 'normal'; ?>" > 
				<?=$vars['BonusTabProperties']['text']; ?> 
				<img src="img/x.gif" class="favorIcon" alt="<?=T("Global", "This tab is set as favourite"); ?>"/> 
			</a> 
		</div>
		...
		<div class="content favor <?=$favorTabId==8 ? "favorActive" : ''; ?> favorKey8" > 
			<a id="<?=$button_id=get_button_id(); ?>" href="statistiken.php?id=8" class="tabItem <?=$vars['farmTabProperties']['active'] ? 'active' : 'normal'; ?>" > 
				<?=$vars['farmTabProperties']['text']; ?> 
				<img src="img/x.gif" class="favorIcon" alt="<?=T("Global", "This tab is set as favourite"); ?>"/> 
			</a> 
		</div>

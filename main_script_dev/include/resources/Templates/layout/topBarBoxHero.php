<div id="topBarHero">
	<svg class="health" viewBox="0 0 110 110">
		...
		<image xlink:href="<?=get_gpack_cdn_mainPage_url();?>img_ltr/hud/topBar/header/hero/health.png" x="0" y="0" width="110" height="110" style="clip-path: url(#healthMask);"></image>
	...
	<svg class="experience" viewBox="0 0 110 110">
		...
		<image xlink:href="<?=get_gpack_cdn_mainPage_url();?>img_ltr/hud/topBar/header/hero/experience.png" x="0" y="0" width="110" height="110" style="clip-path: url(#experienceMask);"></image>
		<!-- last two parameters give correct effect -->
	...
	<a id="heroImageButton" href="/hero.php<?=$vars['hasNewPoints'] ? "?flagAttributesBoxOpen" : ''; ?>" class="heroImageButton" type="button" title="<?=T("HeroGlobal","HeroOverview"); ?>||<?=htmlspecialchars($vars['longStatus']); ?>">
        <div class="heroImageHover"><img class="heroImage" src="hero_head.php?uid=<?=$vars['uid']; ?>&amp;size=sideinfo&amp;<?=$vars['heroImageHash']; ?>" title="Hero" alt="Hero" data-cmp-info="9"></div>
	</a>

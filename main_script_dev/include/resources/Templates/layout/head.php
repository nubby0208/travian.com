...
<head>
    ...
    <link href="<?=get_gpack_link_and_hash("default_compressed.css", false); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?=get_gpack_link_and_hash("custom_compressed.css?t=46", false); ?>" rel="stylesheet" type="text/css"/>
    <?php if (is_lowres()): ?>
        <link href="<?=get_gpack_link_and_hash("lowres_compressed.css"); ?>" rel="stylesheet" type="text/css"/>
    <?php endif; ?>
